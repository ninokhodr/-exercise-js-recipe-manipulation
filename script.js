document.addEventListener("DOMContentLoaded", function () {
    ...
    let bottenIngredients = document.querySelectorAll(".ingredients-list-bottom li");
    let smetenIngredients = document.querySelectorAll(".ingredients-list-paste li" );
    let totalIngredientsCount = bottenIngredients.length + smetenIngredients.length;
